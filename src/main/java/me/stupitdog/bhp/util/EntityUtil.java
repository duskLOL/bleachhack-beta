...
public class EntityUtil {
   ...
   public static double getSpeed() {
       final double px = mc.player.posX - mc.player.prevPosX;
       final double pz = mc.player.posZ - mc.player.prevPosZ;
       final float tr = ((float) 20 / 1000.0f);

       double speed = MathHelper.sqrt(px * px + pz * pz) / tr;
       return speed;
    }
