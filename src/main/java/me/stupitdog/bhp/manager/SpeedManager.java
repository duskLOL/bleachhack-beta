...
public class SpeedManager {
    ...
    public void updateValues() {
        double distTraveledLastTickX = Minecraft.getMinecraft().player.posX - Minecraft.getMinecraft().player.prevPosX;
        double distTraveledLastTickZ = Minecraft.getMinecraft().player.posZ - Minecraft.getMinecraft().player.prevPosZ;
        this.speedometerCurrentSpeed = distTraveledLastTickX * distTraveledLastTickX + distTraveledLastTickZ * distTraveledLastTickZ;
        if (didJumpThisTick && (!Minecraft.getMinecraft().player.onGround || isJumping)) {
    ...
    public void updatePlayers() {
        for (EntityPlayer player : Minecraft.getMinecraft().world.playerEntities) {
            if (!(Minecraft.getMinecraft().player.getDistanceSq((Entity)player) < (double)(this.distancer * this.distancer))) continue;
