...
Bhp.instance.fontManager.drawStringWithShadow(this.setting.getName() + " " + ChatFormatting.GRAY + (this.setting.currentEnumName().equalsIgnoreCase("ABC") ? "ABC" : this.setting.currentEnumName()), this.x + 2.3f, this.y - 1.7f - (float) BhpGui.getClickGui().getTextOffset(), this.getState() ? Bhp.instance.moduleManager.getModuleByClass(ClickGui.class).fontColor.getRGB() : Bhp.instance.moduleManager.getModuleByClass(ClickGui.class).fontColor.getRGB());
}
